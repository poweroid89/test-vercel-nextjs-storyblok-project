...
export async function parseCimbniaga() {
    ...
    await page.goto('https://www.cimbniaga.co.id/id/personal/index/jcr:content/responsivegrid/kurs_copy.get-content');
    ...
    const tableBody = document.querySelector('.cimb-table tbody');
